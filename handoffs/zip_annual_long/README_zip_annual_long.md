# Dataset: Long-Form Zip Code Annual Environmental Health Dataset

**File Name:** `zip_annual.parquet`; `zip_annual.csv`  
...
This dataset includes annual summaries of environmental and climate health variables for all U.S. zip codes from 2010 to 2024.

## Usage

This dataset is designed to support geospatial epidemiological analyses and environmental exposure mapping by providing relevant covariates at the zip code and year level.
